...
FIELD_REGEN = np.array((0.0000, 0.000, 0.0005))
...
AGENT_DUPLE_DISTANCE_MUTATION = 3  # Коэфицент мутации дальности отброса семени агентов

AGENT_CONSUMING = (.5, .5, .01)  # Потребление энергии агентом
AGENT_PRODUCING = (0.9, 0.8, 0.8)  # Коэфицент возврата энергии в систему
AGENT_MAX_ENERGY = (200, 200, 200)  # Максимальная энергия системы

AGENT_LIFE_COST = (.001, .05, .001)  # Постянное потребеление энергии агентом
AGENT_LIFE_COST_PER_SPEED = (.2, .02, .02)  # Потребеление энергии агентом за единицу скорости

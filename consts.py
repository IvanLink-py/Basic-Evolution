...
AGENT_PRODUCING = (.8, .8, .8)  # Коэфицент возврата энергии в систему
AGENT_MAX_ENERGY = (200, 200, 200)  # Максимальная энергия системы

AGENT_LIFE_COST = (.05, .05, .05)  # Постянное потребеление энергии агентом
AGENT_LIFE_COST_PER_SPEED = (.0, .0, .0)  # Потребеление энергии агентом за единицу скорости
AGENT_LIFE_COST_PER_SENSE = (.0, .0, .0)  # Потребеление энергии агентом за единицу чувствительности
